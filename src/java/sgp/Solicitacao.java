...
public class Solicitacao {
    ...
    public String getSolicitacoes(int id) {
        String html = "";
        try {
            ...
            if (result.size() > 0) {
                ...
                html += "<th class='tabela'>Tipo de Serviço</th><th class='tabela'>Endereço</th><th class='tabela'>Informação Adicional</th><th class='tabela'>Data da Solicitação</th>";
    ...
    public String getSolicitacoes(String pesquisa, String campo) {
        String html = "";
        try {
            ...
            if (result.size() > 0) {
                html += "<table class='tabela'>";
                html += "<th></th><th></th>";
                html += "<th>USUÁRIO</th> <th>E-MAIL</th> <th>SERVICO</th> "
                ...
                for (Object[] reg : result) {
                    ...
                    html += "<td><a href='editar_solicitacao.jsp?ID=" + reg[0] + "'><img src='../_imagens/editar.png' alt='editar' onmouseover='Tip(\"Editar\")' onmouseout='UnTip()'></a></td>";
                    html += "<td>" + reg[1] + "</td>";
                    html += "<td>" + reg[2] + "</td>";
                    html += "<td>" + reg[4] + "</td>";
                    html += "<td>" + reg[5] + "</td>";
