            ...
            if (request.getParameter("inserir") != null) {
                ...
                if (mensagem.equals("")) {
                    ...
                    try {
                        ...
                        reclamacao.setUsuario(Integer.parseInt(usuario_id));
                        reclamacao.setSecretaria(Integer.parseInt(secretaria));
                        reclamacao.setMensagem(mensagem);
                        reclamacao.inserir();

                        // Após inserir reclamacao redireciona para a página de consultas
