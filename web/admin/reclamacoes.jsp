        ...
        <div id="conteudo-container">
            ...
            <div id="containerinterno">
                ...
                <%
                    ...
                    // Deleta reclamação caso seja encontrado parâmetro "delete"
                    if (request.getParameter("delete") != null) {
                        reclamacao.delete(request.getParameter("ID"));
                    }

                    // Mostrando reclamações cadastradas no sistema
                    if (request.getParameter("pesquisa") == null) {
                        out.println(reclamacao.getReclamacoes());
                    } else {
                        String pesquisa = request.getParameter("pesquisa").trim();
                        out.println(reclamacao.getReclamacoes(pesquisa, campo));
                    }
                %>
            </div>
