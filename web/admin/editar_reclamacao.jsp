...
<html>
    <head>
        ...
        <title>SGP - Editar Reclamação</title>
    ...
    <body>
        <%
            ...
            if (request.getParameter("inserir") != null) {
                ...
                reclamacao = request.getParameter("mensagem").trim();
